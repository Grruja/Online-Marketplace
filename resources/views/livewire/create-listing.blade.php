            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mt-10">
                <form wire:submit="createListing">
                    ...
                    <div class="mt-5">
                        ...
                        <input wire:model="price" id="price" type="number" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                        @error('price') <em class="text-red-600 text-sm">{{ $message }}</em> @enderror
                    </div>
                    <div class="mt-5">
                        <x-input-label for="condition" :value="__('Condition')" />
                        <select wire:model="condition" id="condition" class="cursor-pointer border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                    ...
                    <div class="mt-5">
                        ...
                        <select wire:model="category" id="category" class="cursor-pointer border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option disabled selected value=""></option>
                    ...
                    <div class="mt-5">
                        ...
                        <textarea wire:model="description" id="description" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" rows="7"></textarea>
